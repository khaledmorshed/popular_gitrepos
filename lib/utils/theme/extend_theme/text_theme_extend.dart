...
class TextThemeExtend extends ThemeExtension<TextThemeExtend> {
  ...
  const TextThemeExtend({
    ...
    this.titleMedium,
    this.titleSmall,
    this.txtPrimaryColor,
    this.txtPrimaryColorChangeable,
    this.txtPrimaryColorFirst,
    this.txtPrimaryColorSecond,
    this.txtPrimaryColorThird,
    this.txtColorBlack,
    this.txtColorWhite,
    this.txtBodyColorLarge,
    this.txtBodyColorMoreMedium,
    this.txtBodyColorMedium,
    this.txtBodyColorLessMedium,
    this.txtBodyColorSmall,
    this.txtBodyColorLessSmall,
    this.txtSecondaryColor,
    this.txtSecondaryColorChangeable,
    this.txtSecondaryColorFirst,
    this.txtSecondaryColorSecond,
    this.txtSecondaryColorThird,
    this.txtRedColor,
    this.txtColorFulFirst,
    this.txtColorFulSecond,
    this.txtColorFulThird,
    this.txtColorFulFourth,
    this.txtColorFulFifth,
    this.txtLabelColorLarge,
    this.txtLabelColorMoreMedium,
    this.txtLabelColorMedium,
    this.txtLabelColorLessMedium,
    this.txtLabelColorSmall,
  });
